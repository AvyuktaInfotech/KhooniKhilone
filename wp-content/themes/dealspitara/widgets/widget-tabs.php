...
add_action( 'widgets_init', 'maxmag_tabs_load_widgets' );

function maxmag_tabs_load_widgets() {
	register_widget( 'maxmag_tabs_widget' );
}

class maxmag_tabs_widget extends WP_Widget {

	/**
	 * Widget setup.
	 */
	function maxmag_tabs_widget() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'maxmag_tabs_widget', 'description' => __('A tabber widget that displays recent headlines, popular posts and recent comments.', 'maxmag_tabs_widget') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'maxmag_tabs_widget' );

		/* Create the widget. */
		$this->WP_Widget( 'maxmag_tabs_widget', __('Max Mag: Tabs Widget', 'maxmag_tabs_widget'), $widget_ops, $control_ops );
	}
	...
	<div class="tabber-container">
		<ul class="tabs">
			<li><h4><a href="#tab1"><?php echo $latest_title; ?></a></h4></li>
			<li><h4><a href="#tab2"><?php _e( 'Popular', 'mvp-text' ); ?></a></h4></li>
	...
	function form( $instance ) {
		...
		$defaults = array( 'latest_title' => __('Latest'), 'latest_number' => 3, 'popular_number' => 3, 'comment_number' => 3);
