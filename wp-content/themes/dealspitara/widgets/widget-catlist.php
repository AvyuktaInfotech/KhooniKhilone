...
add_action( 'widgets_init', 'maxmag_catlist_load_widgets' );

function maxmag_catlist_load_widgets() {
	register_widget( 'maxmag_catlist_widget' );
}

class maxmag_catlist_widget extends WP_Widget {

	/**
	 * Widget setup.
	 */
	function maxmag_catlist_widget() {
		/* Widget settings. */
		...
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'maxmag_catlist_widget' );
