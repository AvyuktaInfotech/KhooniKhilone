...
$itemListFrom					= '#e9ecf0';
$itemListTo						= '#ffffff';
$itemListBorder					= '1px solid #bbbbbb';
...
$itemListBorderHover			= '1px solid #bbbbbb';
...
$itemListFromOdd				= '#e9ecf0';
$itemListToOdd					= '#ffffff';
$itemListBorderOdd				= '1px solid #bbbbbb';
...
$itemListBorderOddHover			= '1px solid #bbbbbb';
...
$itemListBorderEven				= '1px solid #bbbbbb';
...
$itemListBorderEvenHover		= '1px solid #bbbbbb';
...
$noticeBorder		= '1px solid #bbbbbb';
$noticeColor		= '#444444';

# ------------------------------------------------------------------
# Alternate Backgrounds
# ------------------------------------------------------------------
$alt1SectionBase		= '#ffffff';
$alt1SectionFrom		= '#d0d9e3';
$alt1SectionTo			= '#ffffff';
$alt1SectionBorder		= '1px solid #bbbbbb';
$alt1SectionColor		= '#555555';
$alt1SectionHover		= '1px solid #bbbbbb';
...
$alt2SectionBorder		= '1px solid #bbbbbb';
$alt2SectionColor		= '#777777';
$alt2SectionHover		= '#d7d8d9';
...
# ------------------------------------------------------------------
$alt1BackGround		= '#505C78';
$alt1Border			= '1px solid #bbbbbb';
$alt1Color			= '#ffffff';
...
$alt3Border			= '1px solid #bbbbbb';
$alt3Color			= '#777777';

$alt4BackGround		= '#FAFBFC';
$alt4Border			= '1px solid #bbbbbb';
$alt4Color			= '#777777';

$alt5BackGround		= '#f0f4f7';
$alt5Border			= '1px solid #bbbbbb';
$alt5Color			= '#777777';
...
$postBorder				= '1px solid #bbbbbb';
$postColor				= '#777777';
$postBackGroundOdd		= '#ffffff';
$postBorderOdd			= '1px solid #bbbbbb';
$postColorOdd			= '#777777';
$postBackGroundEven		= '#FFFFFF';
$postBorderEven			= '1px solid #bbbbbb';
...
$alt1LinkColor			= '#5671AF';
$alt1LinkHover			= '#5671AF';
$alt1LinkDecoration		= 'none';

$alt2LinkColor			= '#3F4C6B';
$alt2LinkHover			= '#3F4C6B';
$alt2LinkDecoration		= 'none';

$alt3LinkColor			= '#3F4C6B';
$alt3LinkHover			= '#5671AF';
$alt3LinkDecoration		= 'none';

$alt4LinkColor			= '#555555';
$alt4LinkHover			= '1px solid #bbbbbb';
$alt4LinkDecoration		= 'none';

$alt5LinkColor			= '#3F4C6B';
$alt5LinkHover			= '#5671AF';
$alt5LinkDecoration		= 'none';

$alt6LinkColor			= '#5671AF';
$alt6LinkHover			= '#5671AF';
