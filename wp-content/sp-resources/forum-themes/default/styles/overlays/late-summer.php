...
$alt3BackGround		= "-moz-linear-gradient(100% 100% 90deg, $itemListFrom, $itemHeaderFrom); background: -webkit-gradient(linear, 0% 0%, 0% 100%, from($itemHeaderFrom), to($itemListFrom)); background-color: $itemHeaderFrom;";
