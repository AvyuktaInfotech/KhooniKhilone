...
class GPAISRSettings {	
	...
	/**
	 * menu function.
	 * will add the menue in the wordpress backend
	 * 
	 * @access public
	 * @param mixed $id
	 * @return void
	...
	public function menu($id){
		$this->pagehook = add_options_page( __('Google Plus Author', 'gpaisr'), __('Google Plus Author', 'gpaisr'), 'administrator', 'gpaisr', array( $this, 'settings_page' ) );
	...
	public function settings_page(){
		...
		add_meta_box( 'gpaisr-contentbox-1', __('General'), array( &$this, 'metabox_general' ), $this->pagehook, 'normal', 'core' );

		// add metabox "howto"
		add_meta_box( 'gpaisr-contentbox-2', __( 'What to do', 'gpaisr' ), array( &$this, 'metabox_howto' ), $this->pagehook, 'normal', 'low' );
		
		// add metabox "settings
		add_meta_box( 'gpaisr-contentbox-3', __( 'Settings' ), array( &$this, 'metabox_settings' ), $this->pagehook, 'normal', 'low' );
		
		// add metabox "share"
		add_meta_box( 'gpaisr-contentbox-4', __( 'Share', 'gpaisr' ), array( &$this, 'metabox_share' ), $this->pagehook, 'side', 'default' );
		
		// add metabox "share"
		add_meta_box( 'gpaisr-contentbox-5', __( 'Discover', 'gpaisr' ), array( &$this, 'metabox_discover' ), $this->pagehook, 'side', 'default' );
...
?>
		...
		<ol id="gplisting">
			...
			<li><?php echo __( 'Copy your Profile-URL from the address bar to clipboard (see picture below):', 'gpaisr' ); ?><br />
				<img src="<?php echo plugins_url( 'images/gplus-profile.jpg', __FILE__ ); ?>" alt="" style="border: 1px solid black;" /></li>
			
			<li><?php echo __( 'Go to your Wordpress Admin Panel and click Users » Your Profile. Paste the above mentioned URL to the field where it says „Google Plus Author Link“.', 'gpaisr' ); ?><br />
				<img src="<?php echo plugins_url( 'images/gplus-update-profile.jpg', __FILE__ ); ?>" alt="" style="border: 1px solid black;" /></li>
		...
		<ol id="gplisting">
			...
			<li><?php echo __( 'In the dialog that appears, click Add custom link, and then enter your website URL.', 'gpaisr' ); ?></li>
...
<?php
	...
	?>
		<p><a href="https://github.com/code-flow/Google-Plus-Author-Information-in-Search-Result--GPAISR-" target="_blank"><?php echo __('Go to the plugins page', 'gpaisr'); ?></a></p>
	
		<!-- Google+ Button -->
		<p><div class="g-plusone" data-size="medium" data-annotation="inline" data-href="https://github.com/code-flow/Google-Plus-Author-Information-in-Search-Result--GPAISR-"></div></p>
		
		<!-- Facebook button -->
		<p><div class="fb-like" data-href="https://github.com/code-flow/Google-Plus-Author-Information-in-Search-Result--GPAISR-" data-send="false" data-layout="button_count" data-width="150" data-show-faces="false"></div></p>
	
		<!-- Flattr Button -->
		<p><a href="https://flattr.com/thing/669124/Google-Author-Information-in-Search-Results-WordPress-Plugin" target="_blank"><img src="http://api.flattr.com/button/flattr-badge-large.png" alt="Flattr this" title="Flattr this" border="0" /></a></p>
		
		<!-- Twitter-Button -->
		<p><a href="https://twitter.com/share" class="twitter-share-button" data-url="https://github.com/code-flow/Google-Plus-Author-Information-in-Search-Result--GPAISR-" data-via="floriansimeth">Tweet</a></p>
		<?php
	}
	...
	public function metabox_discover( $data ){
		?>
		<a href="http://bit.ly/Wn88bZ" target="_blank"><img src="https://sslsites.de/florian-simeth.de/wp-content/uploads/2012/10/affiliate.jpg" border="0" alt="" /></a>
		<?php
	}
	...
	function field_replacement(){
		...
		if( !isset( $options[ 'replacement' ] ) ) $options[ 'replacement' ] = 0;
	...
	function field_hide(){
		$options = get_option('gpaisr');
		if( !isset( $options[ 'hide' ] ) ) $options[ 'hide' ] = 0;
		echo "<input ".(($options['hide'] == 1) ? 'checked="checked"' : '')." id='gpaisr_replace_hide_1' name='gpaisr[hide]'  type='radio' value='1' /> ".__('Hide');
		echo "<br /><input ".((empty($options['hide'])) ? 'checked="checked"' : '')." id='gpaisr_replace_hide_0' name='gpaisr[hide]'  type='radio' value='0' /> ".__('Show') . ' <small>' . __( '(Please not that Google does not like hidden links)', 'gpaisr' ) . '</small>';
	}
	...
	function field_new_window(){
		$options = get_option('gpaisr');
		echo "<input ".(( isset( $options['new_window'] ) && $options['new_window'] == 1) ? 'checked="checked"' : '')." id='gpaisr_new_window' name='gpaisr[new_window]'  type='checkbox' value='1' /> <small>(".__('Only applied when link is displayed after the content', 'gpaisr').')</small>';
	}
